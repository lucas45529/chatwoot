  ...
  let(:base_env) do
    {
      ...
      'AGENT_LEARNING_DATABASE_USER' => 'agent_learning_ro',
      'AGENT_LEARNING_DATABASE_PASSWORD' => 'b' * 32,
      'AGENT_LEARNING_CHATWOOT_DATABASE_URL' => "postgresql://agent_learning_ro:#{'b' * 32}@postgres:5432/chatwoot",
